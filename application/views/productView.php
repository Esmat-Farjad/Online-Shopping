                ...
                <div class="info">
                    ...
                    <div class="separator clear-left">
                        ...
                        <?php if($this->session->has_userdata('first_name')){ ?> 
                            <i class="fa fa-shopping-cart"></i><a href="<?php echo base_url()?>index.php/My_controller/checkLogin" class="hidden-sm">Add to cart</a></p>
                        <?php
                        }
                        else
                        {
                        ?>
                            <i class="fa fa-shopping-cart"></i><a href="<?php echo base_url()?>index.php/My_controller/login" class="hidden-sm">Add to cart</a></p>
